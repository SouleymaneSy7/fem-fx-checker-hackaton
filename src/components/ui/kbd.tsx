  ...
  return (
    <kbd
      ...
      className={cn(
        ...
        "preset-5 text-foreground",
        "rounded-4 border border-neutral-400 border-b-[3px] bg-neutral-500 px-step-075 py-step-025",
...
function KbdGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="kbd-group"
      className={cn("inline-flex items-center gap-step-075", className)}
      {...props}
    />
  );
}
