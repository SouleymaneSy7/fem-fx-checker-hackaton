  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="first:block! size-full rounded-[inherit] outline-none transition-[color,box-shadow] first:min-w-0! focus-visible:outline-1 focus-visible:ring-[3px] focus-visible:ring-ring/50"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
